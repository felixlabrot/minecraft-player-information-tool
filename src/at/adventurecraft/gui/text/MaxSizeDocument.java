package at.adventurecraft.gui.text;
...
public final class MaxSizeDocument extends PlainDocument {
    ...
    public MaxSizeDocument(final int maxSize) {
        if(maxSize < 0) throw new IllegalArgumentException("Maximum size must be greater or equal zero!");
     ...
     */
    @Override public void insertString(final int offset, final String text, final AttributeSet attributeSet) throws BadLocationException {
